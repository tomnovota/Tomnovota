...
HD_PWD='X:/SAP/lab4/lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_vhdl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplier_vhdl.tcl
