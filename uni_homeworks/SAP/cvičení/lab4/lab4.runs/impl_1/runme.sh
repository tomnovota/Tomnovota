...
HD_PWD='X:/SAP/lab4/lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_vhdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiplier_vhdl.tcl -notrace
