...
HD_PWD='X:/SAP/final/final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log code_lock_vhdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source code_lock_vhdl.tcl -notrace
