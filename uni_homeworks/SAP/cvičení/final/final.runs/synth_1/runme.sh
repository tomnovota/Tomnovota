...
HD_PWD='X:/SAP/final/final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log code_lock_vhdl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source code_lock_vhdl.tcl
