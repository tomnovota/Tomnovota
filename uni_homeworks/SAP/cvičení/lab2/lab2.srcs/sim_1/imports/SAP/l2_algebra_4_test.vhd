...
architecture behavioral of algebra_4_test is
...
begin
    ...
    -- outputs: f
    -- ATTENTION!
    -- The entity name (entity work.algebra_4) must be equal to the tested component name
    -- In this case: algebra_4
    ...
    -- vystupy: f
    -- POZOR!
    -- nazev entity (entity work.algebra_4) musi byt stejny jako nazev testovane entity
    -- v tomto pripade: algebra_4
    -- vstupy a vystupy (v leve casti pred sipkou) musi byt stejne jako popisy vstupu a vystupu testovane entity

    uut: entity work.algebra_4
    port map(
        d => d,
        c => c,
        b => b,
