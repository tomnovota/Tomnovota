...
HD_PWD='X:/SAP/lab5/lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_full_vhdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter_full_vhdl.tcl -notrace
