...
HD_PWD='X:/SAP/lab5/lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_full_vhdl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_full_vhdl.tcl
