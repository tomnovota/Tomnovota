...
void deduct ( int num1, int num2, int * doba, int * num11 )
{
    int vysl = num2 - num1;
    if ( vysl < 0 )
    {
...
int vypocet ( T_TIME time1, T_TIME time2 )
{
    ...
    deduct ( time1.ms, time2.ms, &doba.ms, &time1.sec );
    deduct ( time1.sec, time2.sec, &doba.sec, &time1.min );
    deduct ( time1.min, time2.min, &doba.min, &time1.hr );
    deduct ( time1.hr, time2.hr, &doba.hr, &kontrola );
